  ...
  if (pathname === `${ROUTE_PREFIX}/framework-upgrade`) {
    ...
    if (hasUpdate && dshDir !== null) {
      ...
      const lines = [
        ...
        `& ${ps(nodePath)} ${ps(npmCli)} install '@deepseek-ai/dsh@${target}' --no-audit --no-fund --registry https://registry.npmmirror.com --fetch-timeout=45000 --fetch-retries=1 --fetch-retry-mintimeout=5000`,

window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			pendingCompatHint: "框架升级后被强制禁用：点下方「更新并适配」更新到最新版，更新完成自动校验通过后自动解锁启用",
		...
		const en = {
			...
			pendingCompatHint: "Force-disabled after framework upgrade: click Update & adapt below to update to the latest version; it unlocks automatically after the compat check passes",

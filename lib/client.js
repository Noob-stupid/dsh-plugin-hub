						...
						el("div", { className: styles.modalCard, style: { maxWidth: 560 } },
							...
							el("div", { className: styles.rowTop, style: { flexWrap: "wrap" } },
								...
								(state.status === "ready" && state.data.rollback)
									? el("button", { type: "button", className: styles.toggle, title: t("frameworkRollbackTitle"), disabled: frameworkUpgrading, onClick: doFrameworkRollback }, t("frameworkRollbackBtn") + " → " + (state.data.rollback.from ?? "?"))
									: null,

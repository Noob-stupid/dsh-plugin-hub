		...
		function PluginConsoleTab({ t }) {
			...
			return el("section", { className: styles.section, "aria-busy": state.status === "loading" },
				...
				el("div", { className: styles.marketHead },
					...
					el("button", { type: "button", className: styles.toggle, onClick: () => { setInstalledSearchOpen((v) => !v); setInstalledQuery(""); } }, t(installedSearchOpen ? "closeSearch" : "search"))),
				installedSearchOpen
					? el("div", { className: styles.search },
						el("input", {
							type: "search",

window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function PluginConsoleTab({ t }) {
			...
			// 面板重开时恢复 AI 赋能任务（服务端任务常驻内存，前端只需恢复轮询——关闭面板不会中断赋能）
			react.useEffect(() => {
				try {
